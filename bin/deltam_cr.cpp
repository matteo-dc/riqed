...
vvvd_t compute_deltam_cr(const int T, const int nconfs, const int njacks,const int* conf_id, const string &string_path, const int t_min, const int t_max)
{
  ...
  for(int mr_fw=0;mr_fw<nmr;mr_fw++)
	...
	for(int t=0;t<T/2+1;t++)
	  {
	    num_deltam_cr_corr[mr_fw][mr_bw][ijack][t]=jV0P5_LL[mr_fw][mr_bw][ijack][t]+2.0*jV0P5_0M[mr_fw][mr_bw][ijack][t]/*+jV0P5_M0[mr_fw][mr_bw][ijack][t]*/+2.0*jV0P5_0T[mr_fw][mr_bw][ijack][t]/*+jV0P5_T0[mr_fw][mr_bw][ijack][t]*/;
	    den_deltam_cr_corr[mr_fw][mr_bw][ijack][t]=/*+jV0P5_P0[mr_fw][mr_bw][ijack][t]+*/2.0*jV0P5_0P[mr_fw][mr_bw][ijack][t];
