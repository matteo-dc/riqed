        ...
        for(int m_bw=0;m_bw<nm;m_bw++)
            for(int ijack=0;ijack<njacks;ijack++)
                for(int r=0;r<nr;r++)
                {
                    ...
                    A = symmetrize(symmetric_derivative(jV0P5_QED[mr_fw][mr_bw][ijack])/jP5P5_LO[mr_fw][mr_bw][ijack] - symmetric_derivative(jV0P5_LO[mr_fw][mr_bw][ijack])*jP5P5_QED[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack],1);
                    B = symmetrize(symmetric_derivative(jV0P5_S[mr_fw][mr_bw][ijack])/jP5P5_LO[mr_fw][mr_bw][ijack] - symmetric_derivative(jV0P5_LO[mr_fw][mr_bw][ijack])*jP5P5_S[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack],1);
                    C = symmetrize(symmetric_derivative(jV0P5_P[mr_fw][mr_bw][ijack])/jP5P5_LO[mr_fw][mr_bw][ijack] - symmetric_derivative(jV0P5_LO[mr_fw][mr_bw][ijack])*jP5P5_P[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack],1);
                    
                    D = effective_slope(symmetrize(jP5P5_QED[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack],1),eff_mass_time[mr_fw][mr_bw][ijack],T/2);
                    E = effective_slope(symmetrize(jP5P5_S[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack],1),eff_mass_time[mr_fw][mr_bw][ijack],T/2);
                    F = effective_slope(symmetrize(jP5P5_P[mr_fw][mr_bw][ijack]/jP5P5_LO[mr_fw][mr_bw][ijack],1),eff_mass_time[mr_fw][mr_bw][ijack],T/2);
