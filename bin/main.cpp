...
#pragma omp master
  ...
  //create gamma matrices
   ...
   vector<vXd_t> jZq_pars_allmoms(moms), jSigma1_pars_allmoms(moms), jZq_em_pars_allmoms(moms), jSigma1_em_pars_allmoms(moms);
...
#pragma omp parallel for collapse(2)
   ...
   vector<jZ_t> jZq_eqmoms(neq_moms,vvd_t(vd_t(0.0,nmr),njacks)), jSigma1_eqmoms(neq_moms,vvd_t(vd_t(nmr),njacks)), \
