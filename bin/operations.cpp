...
#pragma omp parallel for collapse(6)
        ...
        cout<<"r=[0,0] m=[0,1] jG_V "<<jG[0][1][0][0][0+_nr*0][0+_nr*1]<<endl;
        cout<<"r=[1,1] m=[0,1] jG_V "<<jG[0][1][0][0][1+_nr*0][1+_nr*1]<<endl;
        cout<<" --> "<<(out.jG)[0][1][0][0][0][1]<<endl;
        
        cout<<"r=[0,0] m=[1,0] jG_V  "<<jG[0][1][0][0][0+_nr*1][0+_nr*0]<<endl;
        cout<<"r=[1,1] m=[1,0] jG_V  "<<jG[0][1][0][0][1+_nr*1][1+_nr*0]<<endl;
        cout<<" --> "<<(out.jG)[0][1][0][0][1][0]<<endl;
        
        cout<<"r=[0,0] m=[0,1] jG_A "<<jG[0][3][0][0][0+_nr*0][0+_nr*1]<<endl;
        cout<<"r=[1,1] m=[0,1] jG_A "<<jG[0][3][0][0][1+_nr*0][1+_nr*1]<<endl;
        cout<<" --> "<<(out.jG)[0][3][0][0][0][1]<<endl;
        
        cout<<"r=[0,0] m=[1,0] jG_A  "<<jG[0][3][0][0][0+_nr*1][0+_nr*0]<<endl;
        cout<<"r=[1,1] m=[1,0] jG_A  "<<jG[0][3][0][0][1+_nr*1][1+_nr*0]<<endl;
        cout<<" --> "<<(out.jG)[0][3][0][0][1][0]<<endl;
