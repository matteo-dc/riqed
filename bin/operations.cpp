...
void oper_t::plot(const string suffix)
{
    ...
    {
        Zq_data   <<p2[imom]<<"\t"<<p2t[imom]<<"\t"<<Zq_ave[imom][0]<<"\t"<<Zq_err[imom][0]<<endl;
        Zq_EM_data<<p2[imom]<<"\t"<<p2t[imom]<<"\t"<<Zq_EM_ave[imom][0]<<"\t"<<Zq_EM_err[imom][0]<<endl;
    }
...
//            int imomk = in.linmoms[imomq][0];
            ...
            Zbil_data[ibil]   <<p2[imomk]<<"\t"<<p2t[imomk]<<"\t"<<Z_ave[imom][ibil][0][0]<<"\t"<<Z_err[imom][ibil][0][0]<<endl;
            Zbil_EM_data[ibil]<<p2[imomk]<<"\t"<<p2t[imomk]<<"\t"<<Z_EM_ave[imom][ibil][0][0]<<"\t"<<Z_EM_err[imom][ibil][0][0]<<endl;
        }
    }
    ...
    for(int imom=0; imom<in._bilmoms; imom++)
    {
        ...
        ZVovZA_data<<p2[imomk]<<"\t"<<p2t[imomk]<<"\t"<<ZVovZA_ave[imom][0][0][0]<<"\t"<<ZVovZA_err[imom][0][0][0]<<endl;
        ZPovZS_data<<p2[imomk]<<"\t"<<p2t[imomk]<<"\t"<<ZPovZS_ave[imom][0][0][0]<<"\t"<<ZPovZS_err[imom][0][0][0]<<endl;
    }
    ...
    if(compute_4f)
    {
        ...
        for(int i=0;i<nbil*nbil;i++)
        {
            ...
            for(int imom=0; imom<in._bilmoms; imom++)
            {
                ...
                Z_4f_data[i]   <<p2[imomk]<<"\t"<<p2t[imomk]<<"\t"<<Z_4f_ave[imom][iop1][iop2][0][0]<<"\t"<<Z_4f_err[imom][iop1][iop2][0][0]<<endl;
                Z_4f_EM_data[i]<<p2[imomk]<<"\t"<<p2t[imomk]<<"\t"<<Z_4f_EM_ave[imom][iop1][iop2][0][0]<<"\t"<<Z_4f_EM_err[imom][iop1][iop2][0][0]<<endl;
            }
        }
    }
    else
...
void oper_t::plot(const string suffix, int b)
{
    ...
    for(int imom=0; imom<in._linmoms; imom++)
    {
        Zq_data   <<p2[imom]*ainv2<<"\t"<<p2t[imom]*ainv2<<"\t"<<Zq_ave[imom][0]<<"\t"<<Zq_err[imom][0]<<endl;
        Zq_EM_data<<p2[imom]*ainv2<<"\t"<<p2t[imom]*ainv2<<"\t"<<Zq_EM_ave[imom][0]<<"\t"<<Zq_EM_err[imom][0]<<endl;
    }
    ...
    for(int ibil=0;ibil<nbil;ibil++)
    {
        ...
        for(int imom=0; imom<in._bilmoms; imom++)
        {
            ...
            Zbil_data[ibil]   <<p2[imomk]*ainv2<<"\t"<<p2t[imomk]*ainv2<<"\t"<<Z_ave[imom][ibil][0][0]<<"\t"<<Z_err[imom][ibil][0][0]<<endl;
            Zbil_EM_data[ibil]<<p2[imomk]*ainv2<<"\t"<<p2t[imomk]*ainv2<<"\t"<<Z_EM_ave[imom][ibil][0][0]<<"\t"<<Z_EM_err[imom][ibil][0][0]<<endl;
        }
    }
    ...
    for(int imom=0; imom<in._bilmoms; imom++)
    {
        ...
        ZVovZA_data<<p2[imomk]*ainv2<<"\t"<<p2t[imomk]*ainv2<<"\t"<<ZVovZA_ave[imom][0][0][0]<<"\t"<<ZVovZA_err[imom][0][0][0]<<endl;
        ZPovZS_data<<p2[imomk]*ainv2<<"\t"<<p2t[imomk]*ainv2<<"\t"<<ZPovZS_ave[imom][0][0][0]<<"\t"<<ZPovZS_err[imom][0][0][0]<<endl;
    }
    ...
    if(compute_4f)
    {
        ...
        for(int i=0;i<nbil*nbil;i++)
        {
            ...
            for(int imom=0; imom<in._bilmoms; imom++)
            {
                ...
                Z_4f_data[i]   <<p2[imomk]*ainv2<<"\t"<<p2t[imomk]*ainv2<<"\t"<<Z_4f_ave[imom][iop1][iop2][0][0]<<"\t"<<Z_4f_err[imom][iop1][iop2][0][0]<<endl;
                Z_4f_EM_data[i]<<p2[imomk]*ainv2<<"\t"<<p2t[imomk]*ainv2<<"\t"<<Z_4f_EM_ave[imom][iop1][iop2][0][0]<<"\t"<<Z_4f_EM_err[imom][iop1][iop2][0][0]<<endl;
            }
        }
    }
    else
