...
//                            int ibil2=ibil_of_iop[iop1][1];
                            ...
                            if(iop1==iop2)
                            {
                                jZ_em_4f[ibilmom][iop1][iop2][ijack][mr_fw][mr_bw] += 0.5*(q1*q1*jZq_em[imom1][ijack][mr_fw]/jZq[imom1][ijack][mr_fw] + q2*q2*jZq_em[imom2][ijack][mr_bw]/jZq[imom2][ijack][mr_bw]);
                            }
